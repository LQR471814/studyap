...
export const questionChoiceRelations = relations(
  questionChoice,
  ({ one, many }) => ({
    mcqAttempt: many(mcqAttempt),
    question: one(question, {
...
export const questionUnitRelations = relations(
  questionUnit,
  ({ one, many }) => ({
    unit: one(unit, {
...
export const stimulusUnitRelations = relations(
  stimulusUnit,
  ({ one, many }) => ({
    stimulus: one(stimulus, {
...
export const testStimulusRelations = relations(
  testStimulus,
  ({ one, many }) => ({
    frqAttempt: many(frqAttempt),
    mcqAttempt: many(mcqAttempt),
